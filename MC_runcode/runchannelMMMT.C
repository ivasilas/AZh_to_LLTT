#define runchannelMMMT_cxx
#include "runchannelMMMT.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <cmath>
void runchannelMMMT::Loop(const std::string SampleName,const int maxEvents)
{
//   In a ROOT session, you can do:
//      Root > .L runchannelMMMT.C
//      Root > runchannelMMMT t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Long64_t nbytes = 0, nb = 0;
    runchannelMMMT::MMMT_PartInfo aParticle;
   ...
   cout<<"RUNNING SAMPLE "<<SampleName<<" runchannel CHANNEL MMMT"<<endl;
   TString fullName = SampleName+"MMMT.root";
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if (eVetoAZHdR0 !=0 || muVetoAZHdR0>3) continue;
      ...
      if(m3Pt <= 10 || abs(m3Eta) >= 2.4 || abs(m3PVDXY)>=0.045 || abs(m3PVDZ)>=0.2 || m3_t_DR <= 0.5) continue;
      if(abs(tEta) >= 2.3 || tPt <= 19 || abs(tPVDZ)>=0.2 || tDecayModeFinding !=1 || tAgainstElectronVLooseMVA6 !=1 || tAgainstMuonLoose3 !=1 || abs(tCharge) != 1 || tAgainstMuonTight3 !=1) continue; 
       ...
       if (!(MMMT_ZMMSelection(aParticle))) continue; 
       ...
       RelIsoDB_3=m3RelPFIsoDBDefaultR04;
       RelIsoDB_4=-999.0;
       // Event ID Var 	 
       run_1=run;
       lumi_1 =lumi; 	 
       ...
       MvaMetCovMatrix00_1_3= m1_m3_MvaMetCovMatrix00;
       MvaMetCovMatrix01_1_3= m1_m3_MvaMetCovMatrix01;
       MvaMetCovMatrix10_1_3= m1_m3_MvaMetCovMatrix10;
       MvaMetCovMatrix11_1_3= m1_m3_MvaMetCovMatrix11;
       ...
       MvaMetCovMatrix00_2_3= m2_m3_MvaMetCovMatrix00;
       MvaMetCovMatrix01_2_3= m2_m3_MvaMetCovMatrix01;
       MvaMetCovMatrix10_2_3= m2_m3_MvaMetCovMatrix10;
       MvaMetCovMatrix11_2_3= m2_m3_MvaMetCovMatrix11;
       ...
       MvaMetCovMatrix00_3_4= m3_t_MvaMetCovMatrix00;
       MvaMetCovMatrix01_3_4= m3_t_MvaMetCovMatrix01;
       MvaMetCovMatrix10_3_4= m3_t_MvaMetCovMatrix10;
       MvaMetCovMatrix11_3_4= m3_t_MvaMetCovMatrix11;
       ...
       PFChargedIso_3 = m3PFChargedIso;
       PFNeutralIso_3 = m3PFNeutralIso;
       PFPUChargedIso_3 = m3PFPUChargedIso;
       PFPhotonIso_3 = m3PFPhotonIso;
       ...
       isTracker_3 = m3IsTracker;
       isTracker_4 = 1;
       
       isGlobal_1 = m1IsGlobal;
       isGlobal_2 = m2IsGlobal;
       isGlobal_3 = m3IsGlobal;
       isGlobal_4 = 1;
       ...
       ZTTGenMatching_3=m3ZTTGenMatching;
       ...
       JetEtaEtaMoment_3=m3JetEtaEtaMoment;
       JetEtaPhiMoment_3=m3JetEtaPhiMoment;
       JetPhiPhiMoment_3=m3JetPhiPhiMoment;
...
bool runchannelMMMT::MMMT_ZMMSelection(MMMT_PartInfo aParticle)
{
