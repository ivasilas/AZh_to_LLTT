#define runchannelMMEM_cxx
#include "runchannelMMEM.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <cmath>
void runchannelMMEM::Loop(const std::string SampleName,const int maxEvents)
{
//   In a ROOT session, you can do:
//      Root > .L runchannelMMEM.C
//      Root > runchannelMMEM t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   runchannelMMEM::MMEM_PartInfo aParticle;
   ...
   cout<<"RUNNING SAMPLE "<<SampleName<<" CHANNEL MMEM"<<endl;
   TString fullName = SampleName+"MMEM.root";
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if (eVetoAZHdR0>1 || muVetoAZHdR0>3) continue;
      if (doubleMuPass <= 0) continue;

      if(abs(m1Eta) >= 2.4 || abs(m1PVDXY)>=0.045 || abs(m1PVDZ)>=0.2) continue;
      if(abs(m2Eta) >= 2.4 || abs(m2PVDXY)>=0.045 || abs(m2PVDZ)>=0.2) continue;
      
      if(ePt <= 10 || abs(eEta) >= 2.5 || abs(ePVDXY)>=0.045 || abs(ePVDZ) >= 0.2 || ePassesConversionVeto <= 0.5 || eMissingHits >= 2) continue;
      if(m3Pt <= 10 || abs(m3Eta) >= 2.4 || abs(m3PVDXY)>=0.045 || abs(m3PVDZ)>=0.2) continue;

      aParticle.s_mu2_Pt =m2Pt;
      aParticle.s_mu1_Pt =m1Pt;
      aParticle.s_mu3_Pt =m3Pt;
       
      aParticle.s_mu1_MatchesDoubleMu=m1MatchesDoubleMu;    
      aParticle.s_mu2_MatchesDoubleMu=m2MatchesDoubleMu;
      aParticle.s_mu3_MatchesDoubleMu=m3MatchesDoubleMu;
      ...
      aParticle.s_mu3_MatchesDoubleMuFilter1=m3MatchesDoubleMuFilter1;
      aParticle.s_mu3_MatchesDoubleMuFilter2=m3MatchesDoubleMuFilter2;
      
      if (!(MMEM_ZMMSelection(aParticle))) continue; 
      ...
      RelIsoDB_4=m3RelPFIsoDBDefaultR04;
      ...
      MtToPfMet_4=m3MtToPfMet_type1;
      
      costhetastar_1_2 =m1_m2_CosThetaStar;
      costhetastar_1_3 =e_m2_CosThetaStar;
      costhetastar_1_4 =m1_m3_CosThetaStar;
      costhetastar_2_3 =e_m2_CosThetaStar;
      costhetastar_2_4 =m2_m3_CosThetaStar;
      costhetastar_3_4 =e_m3_CosThetaStar;
      ...
      MvaMetCovMatrix00_1_4= m1_m3_MvaMetCovMatrix00;
      MvaMetCovMatrix01_1_4= m1_m3_MvaMetCovMatrix01;
      MvaMetCovMatrix10_1_4= m1_m3_MvaMetCovMatrix10;
      MvaMetCovMatrix11_1_4= m1_m3_MvaMetCovMatrix11;
      ...
      MvaMetCovMatrix00_2_4= m2_m3_MvaMetCovMatrix00;
      MvaMetCovMatrix01_2_4= m2_m3_MvaMetCovMatrix01;
      MvaMetCovMatrix10_2_4= m2_m3_MvaMetCovMatrix10;
      MvaMetCovMatrix11_2_4= m2_m3_MvaMetCovMatrix11;
      
      MvaMetCovMatrix00_3_4= e_m3_MvaMetCovMatrix00;
      MvaMetCovMatrix01_3_4= e_m3_MvaMetCovMatrix01;
      MvaMetCovMatrix10_3_4= e_m3_MvaMetCovMatrix10;
      MvaMetCovMatrix11_3_4= e_m3_MvaMetCovMatrix11;
      ...
      PFChargedIso_4 = m3PFChargedIso;
      PFNeutralIso_4 = m3PFNeutralIso;
      PFPUChargedIso_4 = m3PFPUChargedIso;
      PFPhotonIso_4 = m3PFPhotonIso;
      ...
      isTracker_3 = 1;
      isTracker_4 = m3IsTracker;
      
      isGlobal_1 = m1IsGlobal;
      isGlobal_2 = m2IsGlobal;
      isGlobal_3 = 1;
      isGlobal_4 = m3IsGlobal;
      ...
      ZTTGenMatching_4=m3ZTTGenMatching;
     ...
     //Closest_ZMMPlus2=closestMassZMMPlus2;
      ...
      JetEtaEtaMoment_4=m3JetEtaEtaMoment;
      JetEtaPhiMoment_4=m3JetEtaPhiMoment;
      JetPhiPhiMoment_4=m3JetPhiPhiMoment;
...
bool runchannelMMEM::MMEM_ZMMSelection(MMEM_PartInfo aParticle)
{
  ...
  if (aParticle.s_mu1_MatchesDoubleMu > 0 && (aParticle.s_mu1_MatchesDoubleMuFilter1 >0 || aParticle.s_mu1_MatchesDoubleMuFilter2 >0) && aParticle.s_mu3_MatchesDoubleMu > 0 && (aParticle.s_mu3_MatchesDoubleMuFilter1 >0 || aParticle.s_mu3_MatchesDoubleMuFilter2 >0) && ((aParticle.s_mu1_Pt > 18  && aParticle.s_mu3_Pt> 10) || (aParticle.s_mu1_Pt > 10  && aParticle.s_mu3_Pt> 18))) {mmmTrig=true;}  
  if (aParticle.s_mu2_MatchesDoubleMu > 0 && (aParticle.s_mu2_MatchesDoubleMuFilter1 >0 || aParticle.s_mu2_MatchesDoubleMuFilter2 >0) && aParticle.s_mu3_MatchesDoubleMu > 0 && (aParticle.s_mu3_MatchesDoubleMuFilter1 >0 || aParticle.s_mu3_MatchesDoubleMuFilter2 >0) && ((aParticle.s_mu2_Pt > 18  && aParticle.s_mu3_Pt> 10) || (aParticle.s_mu2_Pt > 10  && aParticle.s_mu3_Pt> 18))) {mmmTrig=true;}    
