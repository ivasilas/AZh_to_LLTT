#define runchannelEEET_cxx
#include "runchannelEEET.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <cmath>
void runchannelEEET::Loop(const std::string SampleName,const int maxEvents)
{
//   In a ROOT session, you can do:
//      Root > .L runchannelEEET.C
//      Root > runchannelEEET t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   runchannelEEET::EEET_PartInfo aParticle;
   ...
   cout<<"RUNNING SAMPLE "<<SampleName<<" runchannel CHANNEL EEET"<<endl;
   TString fullName = SampleName+"EEET.root";
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if (eVetoAZHdR0 > 3 || muVetoAZHdR0 != 0) continue;
      if (doubleE_23_12Pass <= 0) continue;

      if(abs(e1Eta) >= 2.5 || abs(e1PVDXY)>=0.045 || abs(e1PVDZ)>=0.2 || e1PassesConversionVeto <= 0.5 || e1MissingHits >= 2 || e1_t_DR <= 0.5) continue;
      if(abs(e2Eta) >= 2.5 || abs(e2PVDXY)>=0.045 || abs(e2PVDZ) >= 0.2 || e2PassesConversionVeto <= 0.5 || e2MissingHits >= 2 || e2_t_DR <= 0.5) continue; 
      if(abs(e3Eta) >= 2.5 || e3Pt <= 10 || abs(e3PVDXY)>=0.045 || abs(e3PVDZ) >= 0.2 || e3PassesConversionVeto <= 0.5 || e3MissingHits >= 2 || e3_t_DR <= 0.5) continue;
      ...
      if (!(EEET_ZEESelection(aParticle))) continue;
      count = count+1;
      ...
      costhetastar_1_4 =e1_t_CosThetaStar;
      costhetastar_2_3 =e2_e3_CosThetaStar;
      costhetastar_2_4 =e2_t_CosThetaStar;
      costhetastar_3_4 =e3_t_CosThetaStar;
      ...
      MvaMetCovMatrix00_1_4= e1_t_MvaMetCovMatrix00;
      MvaMetCovMatrix01_1_4= e1_t_MvaMetCovMatrix01;
      MvaMetCovMatrix10_1_4= e1_t_MvaMetCovMatrix10;
      MvaMetCovMatrix11_1_4= e1_t_MvaMetCovMatrix11;
      ...
      MvaMetCovMatrix00_2_4= e2_t_MvaMetCovMatrix00;
      MvaMetCovMatrix01_2_4= e2_t_MvaMetCovMatrix01;
      MvaMetCovMatrix10_2_4= e2_t_MvaMetCovMatrix10;
      MvaMetCovMatrix11_2_4= e2_t_MvaMetCovMatrix11;
	
      MvaMetCovMatrix00_3_4= e3_t_MvaMetCovMatrix00;
      MvaMetCovMatrix01_3_4= e3_t_MvaMetCovMatrix01;
      MvaMetCovMatrix10_3_4= e3_t_MvaMetCovMatrix10;
      MvaMetCovMatrix11_3_4= e3_t_MvaMetCovMatrix11;
...
bool runchannelEEET::EEET_ZEESelection(EEET_PartInfo aParticle)
{
