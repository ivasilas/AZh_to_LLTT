#define runchannelEEEM_cxx
#include "runchannelEEEM.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <cmath>
void runchannelEEEM::Loop(const std::string SampleName,const int maxEvents)
{
//   In a ROOT session, you can do:
//      Root > .L runchannelEEEM.C
//      Root > runchannelEEEM t
//      Root > t.GetEntry(12); // Fill t daAta members with entry number 12
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   runchannelEEEM::EEEM_PartInfo aParticle;
   ...
   cout<<"RUNNING SAMPLE "<<SampleName<<" CHANNEL EEEM"<<endl;
   TString fullName = SampleName+"EEEM.root";
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if (eVetoAZHdR0>3 || muVetoAZHdR0>1) continue;
      if (doubleE_23_12Pass <= 0) continue;
      
    
      if(abs(e1Eta) >= 2.5 || abs(e1PVDXY)>=0.045 || abs(e1PVDZ)>=0.2 || e1PassesConversionVeto <= 0.5 || e1MissingHits >= 2) continue;
      if(abs(e2Eta) >= 2.5 || abs(e2PVDXY)>=0.045 || abs(e2PVDZ) >= 0.2 || e2PassesConversionVeto <= 0.5 || e2MissingHits >= 2) continue; 
      if(abs(e3Eta) >= 2.5 || e3Pt <= 10 || abs(e3PVDXY)>=0.045 || abs(e3PVDZ) >= 0.2 || e3PassesConversionVeto <= 0.5 || e3MissingHits >= 2 ) continue;
      
      if(abs(mEta) >= 2.4  ||  mPt <= 10 || abs(mPVDXY)>=0.045 || abs(mPVDZ) >= 0.2  ) continue; 
      
        aParticle.s_e1_Pt =e1Pt;
	aParticle.s_e2_Pt =e2Pt;
	aParticle.s_e3_Pt =e3Pt;
	...
	aParticle.s_e3_MatchesDoubleE23_12Path=e3MatchesDoubleE23_12Path;
	...
	aParticle.s_e3_MatchesDoubleE23_12Filter=e3MatchesDoubleE23_12Filter;
		
	if (!(EEEM_ZEESelection(aParticle))) continue;
	...
	RelIsoDB_3=e3RelPFIsoDB;
	RelIsoDB_4=mRelPFIsoDBDefaultR04;
	...
	H_MvaMet=e3_m_MvaMet;
	
	IDLoose_1=e1MVANonTrigWP90;
	IDLoose_2=e2MVANonTrigWP90;
	IDLoose_3=e3MVANonTrigWP90;
	IDLoose_4=mPFIDLoose;

	IDMedium_1=e1MVANonTrigWP90;
	IDMedium_2=e2MVANonTrigWP90;
	IDMedium_3=e3MVANonTrigWP90;
	IDMedium_4=mPFIDMedium;

	IDTight_1=e1MVANonTrigWP80;
	IDTight_2=e2MVANonTrigWP80;
	IDTight_3=e3MVANonTrigWP80;
	IDTight_4=mPFIDTight;
  	
	MtToPfMet_1=e1MtToPfMet_type1;
	MtToPfMet_2=e2MtToPfMet_type1;
	MtToPfMet_3=e3MtToPfMet_type1;
	MtToPfMet_4=mMtToPfMet_type1;

	costhetastar_1_2 =e1_e2_CosThetaStar;
	costhetastar_1_3 =e1_e3_CosThetaStar;
	costhetastar_1_4 =e1_m_CosThetaStar;
	costhetastar_2_3 =e2_e3_CosThetaStar;
	costhetastar_2_4 =e2_m_CosThetaStar;
	costhetastar_3_4 =e3_m_CosThetaStar;
	...
	MvaMetCovMatrix00_1_3= e1_e3_MvaMetCovMatrix00;
	MvaMetCovMatrix01_1_3= e1_e3_MvaMetCovMatrix01;
	MvaMetCovMatrix10_1_3= e1_e3_MvaMetCovMatrix10;
	MvaMetCovMatrix11_1_3= e1_e3_MvaMetCovMatrix11;
	
	MvaMetCovMatrix00_1_4= e1_m_MvaMetCovMatrix00;
	MvaMetCovMatrix01_1_4= e1_m_MvaMetCovMatrix01;
	MvaMetCovMatrix10_1_4= e1_m_MvaMetCovMatrix10;
	MvaMetCovMatrix11_1_4= e1_m_MvaMetCovMatrix11;
	
	MvaMetCovMatrix00_2_3= e2_e3_MvaMetCovMatrix00;
	MvaMetCovMatrix01_2_3= e2_e3_MvaMetCovMatrix01;
	MvaMetCovMatrix10_2_3= e2_e3_MvaMetCovMatrix10;
	MvaMetCovMatrix11_2_3= e2_e3_MvaMetCovMatrix11;
	
	MvaMetCovMatrix00_2_4= e2_m_MvaMetCovMatrix00;
	MvaMetCovMatrix01_2_4= e2_m_MvaMetCovMatrix01;
	MvaMetCovMatrix10_2_4= e2_m_MvaMetCovMatrix10;
	MvaMetCovMatrix11_2_4= e2_m_MvaMetCovMatrix11;
	
	MvaMetCovMatrix00_3_4= e3_m_MvaMetCovMatrix00;
	MvaMetCovMatrix01_3_4= e3_m_MvaMetCovMatrix01;
	MvaMetCovMatrix10_3_4= e3_m_MvaMetCovMatrix10;
	MvaMetCovMatrix11_3_4= e3_m_MvaMetCovMatrix11;

	HadronicOverEM_1 = e1HadronicOverEM;
	HadronicOverEM_2 = e2HadronicOverEM;
	HadronicOverEM_3 = e3HadronicOverEM;
	...
	Charge_3 = e3Charge;
	ChargeIdLoose_3 = e3ChargeIdLoose;
	ChargeIdMed_3 = e3ChargeIdMed;
	ChargeIdTight_3 = e3ChargeIdTight;
	
	PFChargedIso_3 = e3PFChargedIso;
	PFNeutralIso_3 = e3PFNeutralIso;
	PFPUChargedIso_3 = e3PFPUChargedIso;
	PFPhotonIso_3 = e3PFPhotonIso;
	...
	PFChargedIso_4 = mPFChargedIso;
	PFNeutralIso_4 = mPFNeutralIso;
	PFPUChargedIso_4 = mPFPUChargedIso;
	PFPhotonIso_4 = mPFPhotonIso;
	...
	isTracker_2 = 1;
	isTracker_3 = 1;
	isTracker_4 = mIsTracker;
	
	isGlobal_1 = 1;
	isGlobal_2 = 1;
	isGlobal_3 = 1;
	isGlobal_4 = mIsGlobal;
	...
	ZTTGenMatching_3=e3ZTTGenMatching;
	ZTTGenMatching_4=mZTTGenMatching;
	...
	JetEtaEtaMoment_3=e3JetEtaEtaMoment;
	JetEtaPhiMoment_3=e3JetEtaPhiMoment;
	JetPhiPhiMoment_3=e3JetPhiPhiMoment;
	JetEtaEtaMoment_4=mJetEtaEtaMoment;
	JetEtaPhiMoment_4=mJetEtaPhiMoment;
	JetPhiPhiMoment_4=mJetPhiPhiMoment;
...
bool runchannelEEEM::EEEM_ZEESelection(EEEM_PartInfo aParticle)
{
  ...
  if (aParticle.s_e1_MatchesDoubleE23_12Path > 0 && aParticle.s_e1_MatchesDoubleE23_12Filter > 0 && aParticle.s_e3_MatchesDoubleE23_12Path > 0 && aParticle.s_e3_MatchesDoubleE23_12Filter > 0 && ((aParticle.s_e1_Pt > 24 && aParticle.s_e3_Pt > 13) || (aParticle.s_e1_Pt > 13 && aParticle.s_e3_Pt > 24))){eeeTrig=true;}
  if (aParticle.s_e3_MatchesDoubleE23_12Path > 0 && aParticle.s_e3_MatchesDoubleE23_12Filter > 0 && aParticle.s_e2_MatchesDoubleE23_12Path > 0 && aParticle.s_e2_MatchesDoubleE23_12Filter >0 && ((aParticle.s_e3_Pt > 24 && aParticle.s_e2_Pt > 13) || (aParticle.s_e3_Pt > 13 && aParticle.s_e2_Pt > 24))){eeeTrig=true;}
    
  //if (aParticle.s_doubleE_23_12Pass > 0 && aParticle.s_e1_MatchesDoubleE23_12Path > 0 && aParticle.s_e2_MatchesDoubleE23_12Path > 0) {eeTrig=true;}  
