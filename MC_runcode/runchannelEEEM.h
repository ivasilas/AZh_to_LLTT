...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         e3_m_CosThetaStar;
   Float_t         e3_m_DPhi;
   Float_t         e3_m_DR;
   Float_t         e3_m_Eta;
   Float_t         e3_m_Mass;
   Float_t         e3_m_Mass_TauEnDown;
   Float_t         e3_m_Mass_TauEnUp;
   Float_t         e3_m_Mt;
   Float_t         e3_m_MtTotal;
   Float_t         e3_m_Mt_TauEnDown;
   Float_t         e3_m_Mt_TauEnUp;
   Float_t         e3_m_MvaMet;
   Float_t         e3_m_MvaMetCovMatrix00;
   Float_t         e3_m_MvaMetCovMatrix01;
   Float_t         e3_m_MvaMetCovMatrix10;
   Float_t         e3_m_MvaMetCovMatrix11;
   Float_t         e3_m_MvaMetPhi;
   Float_t         e3_m_PZeta;
   Float_t         e3_m_PZetaLess0p85PZetaVis;
   Float_t         e3_m_PZetaVis;
   Float_t         e3_m_Phi;
   Float_t         e3_m_Pt;
   Float_t         e3_m_SS;
   Float_t         e3_m_ToMETDPhi_Ty1;
   Float_t         e3_m_collinearmass;
   Float_t         e3_m_collinearmass_CheckUESDown;
   Float_t         e3_m_collinearmass_CheckUESUp;
   Float_t         e3_m_collinearmass_EleEnDown;
   Float_t         e3_m_collinearmass_EleEnUp;
   Float_t         e3_m_collinearmass_JetCheckTotalDown;
   Float_t         e3_m_collinearmass_JetCheckTotalUp;
   Float_t         e3_m_collinearmass_JetEnDown;
   Float_t         e3_m_collinearmass_JetEnUp;
   Float_t         e3_m_collinearmass_MuEnDown;
   Float_t         e3_m_collinearmass_MuEnUp;
   Float_t         e3_m_collinearmass_TauEnDown;
   Float_t         e3_m_collinearmass_TauEnUp;
   Float_t         e3_m_collinearmass_UnclusteredEnDown;
   Float_t         e3_m_collinearmass_UnclusteredEnUp;
   Float_t         e3_m_pt_tt;
   ...
   Float_t         m_e3_collinearmass;
   Float_t         m_e3_collinearmass_CheckUESDown;
   Float_t         m_e3_collinearmass_CheckUESUp;
   Float_t         m_e3_collinearmass_JetCheckTotalDown;
   Float_t         m_e3_collinearmass_JetCheckTotalUp;
   Float_t         m_e3_collinearmass_JetEnDown;
   Float_t         m_e3_collinearmass_JetEnUp;
   Float_t         m_e3_collinearmass_UnclusteredEnDown;
   Float_t         m_e3_collinearmass_UnclusteredEnUp;
   Float_t         metSig;
   Float_t         metcov00;
   Float_t         metcov01;
   Float_t         metcov10;
   ...
   TBranch        *b_e3_m_CosThetaStar;   //!
   TBranch        *b_e3_m_DPhi;   //!
   TBranch        *b_e3_m_DR;   //!
   TBranch        *b_e3_m_Eta;   //!
   TBranch        *b_e3_m_Mass;   //!
   TBranch        *b_e3_m_Mass_TauEnDown;   //!
   TBranch        *b_e3_m_Mass_TauEnUp;   //!
   TBranch        *b_e3_m_Mt;   //!
   TBranch        *b_e3_m_MtTotal;   //!
   TBranch        *b_e3_m_Mt_TauEnDown;   //!
   TBranch        *b_e3_m_Mt_TauEnUp;   //!
   TBranch        *b_e3_m_MvaMet;   //!
   TBranch        *b_e3_m_MvaMetCovMatrix00;   //!
   TBranch        *b_e3_m_MvaMetCovMatrix01;   //!
   TBranch        *b_e3_m_MvaMetCovMatrix10;   //!
   TBranch        *b_e3_m_MvaMetCovMatrix11;   //!
   TBranch        *b_e3_m_MvaMetPhi;   //!
   TBranch        *b_e3_m_PZeta;   //!
   TBranch        *b_e3_m_PZetaLess0p85PZetaVis;   //!
   TBranch        *b_e3_m_PZetaVis;   //!
   TBranch        *b_e3_m_Phi;   //!
   TBranch        *b_e3_m_Pt;   //!
   TBranch        *b_e3_m_SS;   //!
   TBranch        *b_e3_m_ToMETDPhi_Ty1;   //!
   TBranch        *b_e3_m_collinearmass;   //!
   TBranch        *b_e3_m_collinearmass_CheckUESDown;   //!
   TBranch        *b_e3_m_collinearmass_CheckUESUp;   //!
   TBranch        *b_e3_m_collinearmass_EleEnDown;   //!
   TBranch        *b_e3_m_collinearmass_EleEnUp;   //!
   TBranch        *b_e3_m_collinearmass_JetCheckTotalDown;   //!
   TBranch        *b_e3_m_collinearmass_JetCheckTotalUp;   //!
   TBranch        *b_e3_m_collinearmass_JetEnDown;   //!
   TBranch        *b_e3_m_collinearmass_JetEnUp;   //!
   TBranch        *b_e3_m_collinearmass_MuEnDown;   //!
   TBranch        *b_e3_m_collinearmass_MuEnUp;   //!
   TBranch        *b_e3_m_collinearmass_TauEnDown;   //!
   TBranch        *b_e3_m_collinearmass_TauEnUp;   //!
   TBranch        *b_e3_m_collinearmass_UnclusteredEnDown;   //!
   TBranch        *b_e3_m_collinearmass_UnclusteredEnUp;   //!
   TBranch        *b_e3_m_pt_tt;   //!
   ...
   TBranch        *b_m_e3_collinearmass;   //!
   TBranch        *b_m_e3_collinearmass_CheckUESDown;   //!
   TBranch        *b_m_e3_collinearmass_CheckUESUp;   //!
   TBranch        *b_m_e3_collinearmass_JetCheckTotalDown;   //!
   TBranch        *b_m_e3_collinearmass_JetCheckTotalUp;   //!
   TBranch        *b_m_e3_collinearmass_JetEnDown;   //!
   TBranch        *b_m_e3_collinearmass_JetEnUp;   //!
   TBranch        *b_m_e3_collinearmass_UnclusteredEnDown;   //!
   TBranch        *b_m_e3_collinearmass_UnclusteredEnUp;   //!
   TBranch        *b_metSig;   //!
   TBranch        *b_metcov00;   //!
   TBranch        *b_metcov01;   //!
   TBranch        *b_metcov10;   //!
   ...
   runchannelEEEM(const std::string SampleName,const int maxEvents, TTree *tree=0);
   virtual ~runchannelEEEM();
 ...
 bool EEEM_ZEESelection(EEEM_PartInfo aParticle);
};

#endif

#ifdef runchannelEEEM_cxx
runchannelEEEM::runchannelEEEM(const std::string SampleName, const int maxEvents, TTree *tree) //: fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TChain *mychain = new TChain("eeem/final/Ntuple");
//"Ntuple/tree");
...
runchannelEEEM::~runchannelEEEM()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t runchannelEEEM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t runchannelEEEM::LoadTree(Long64_t entry)
{
...
void runchannelEEEM::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("e3_m_CosThetaStar", &e3_m_CosThetaStar, &b_e3_m_CosThetaStar);
   fChain->SetBranchAddress("e3_m_DPhi", &e3_m_DPhi, &b_e3_m_DPhi);
   fChain->SetBranchAddress("e3_m_DR", &e3_m_DR, &b_e3_m_DR);
   fChain->SetBranchAddress("e3_m_Eta", &e3_m_Eta, &b_e3_m_Eta);
   fChain->SetBranchAddress("e3_m_Mass", &e3_m_Mass, &b_e3_m_Mass);
   fChain->SetBranchAddress("e3_m_Mass_TauEnDown", &e3_m_Mass_TauEnDown, &b_e3_m_Mass_TauEnDown);
   fChain->SetBranchAddress("e3_m_Mass_TauEnUp", &e3_m_Mass_TauEnUp, &b_e3_m_Mass_TauEnUp);
   fChain->SetBranchAddress("e3_m_Mt", &e3_m_Mt, &b_e3_m_Mt);
   fChain->SetBranchAddress("e3_m_MtTotal", &e3_m_MtTotal, &b_e3_m_MtTotal);
   fChain->SetBranchAddress("e3_m_Mt_TauEnDown", &e3_m_Mt_TauEnDown, &b_e3_m_Mt_TauEnDown);
   fChain->SetBranchAddress("e3_m_Mt_TauEnUp", &e3_m_Mt_TauEnUp, &b_e3_m_Mt_TauEnUp);
   fChain->SetBranchAddress("e3_m_MvaMet", &e3_m_MvaMet, &b_e3_m_MvaMet);
   fChain->SetBranchAddress("e3_m_MvaMetCovMatrix00", &e3_m_MvaMetCovMatrix00, &b_e3_m_MvaMetCovMatrix00);
   fChain->SetBranchAddress("e3_m_MvaMetCovMatrix01", &e3_m_MvaMetCovMatrix01, &b_e3_m_MvaMetCovMatrix01);
   fChain->SetBranchAddress("e3_m_MvaMetCovMatrix10", &e3_m_MvaMetCovMatrix10, &b_e3_m_MvaMetCovMatrix10);
   fChain->SetBranchAddress("e3_m_MvaMetCovMatrix11", &e3_m_MvaMetCovMatrix11, &b_e3_m_MvaMetCovMatrix11);
   fChain->SetBranchAddress("e3_m_MvaMetPhi", &e3_m_MvaMetPhi, &b_e3_m_MvaMetPhi);
   fChain->SetBranchAddress("e3_m_PZeta", &e3_m_PZeta, &b_e3_m_PZeta);
   fChain->SetBranchAddress("e3_m_PZetaLess0p85PZetaVis", &e3_m_PZetaLess0p85PZetaVis, &b_e3_m_PZetaLess0p85PZetaVis);
   fChain->SetBranchAddress("e3_m_PZetaVis", &e3_m_PZetaVis, &b_e3_m_PZetaVis);
   fChain->SetBranchAddress("e3_m_Phi", &e3_m_Phi, &b_e3_m_Phi);
   fChain->SetBranchAddress("e3_m_Pt", &e3_m_Pt, &b_e3_m_Pt);
   fChain->SetBranchAddress("e3_m_SS", &e3_m_SS, &b_e3_m_SS);
   fChain->SetBranchAddress("e3_m_ToMETDPhi_Ty1", &e3_m_ToMETDPhi_Ty1, &b_e3_m_ToMETDPhi_Ty1);
   fChain->SetBranchAddress("e3_m_collinearmass", &e3_m_collinearmass, &b_e3_m_collinearmass);
   fChain->SetBranchAddress("e3_m_collinearmass_CheckUESDown", &e3_m_collinearmass_CheckUESDown, &b_e3_m_collinearmass_CheckUESDown);
   fChain->SetBranchAddress("e3_m_collinearmass_CheckUESUp", &e3_m_collinearmass_CheckUESUp, &b_e3_m_collinearmass_CheckUESUp);
   fChain->SetBranchAddress("e3_m_collinearmass_EleEnDown", &e3_m_collinearmass_EleEnDown, &b_e3_m_collinearmass_EleEnDown);
   fChain->SetBranchAddress("e3_m_collinearmass_EleEnUp", &e3_m_collinearmass_EleEnUp, &b_e3_m_collinearmass_EleEnUp);
   fChain->SetBranchAddress("e3_m_collinearmass_JetCheckTotalDown", &e3_m_collinearmass_JetCheckTotalDown, &b_e3_m_collinearmass_JetCheckTotalDown);
   fChain->SetBranchAddress("e3_m_collinearmass_JetCheckTotalUp", &e3_m_collinearmass_JetCheckTotalUp, &b_e3_m_collinearmass_JetCheckTotalUp);
   fChain->SetBranchAddress("e3_m_collinearmass_JetEnDown", &e3_m_collinearmass_JetEnDown, &b_e3_m_collinearmass_JetEnDown);
   fChain->SetBranchAddress("e3_m_collinearmass_JetEnUp", &e3_m_collinearmass_JetEnUp, &b_e3_m_collinearmass_JetEnUp);
   fChain->SetBranchAddress("e3_m_collinearmass_MuEnDown", &e3_m_collinearmass_MuEnDown, &b_e3_m_collinearmass_MuEnDown);
   fChain->SetBranchAddress("e3_m_collinearmass_MuEnUp", &e3_m_collinearmass_MuEnUp, &b_e3_m_collinearmass_MuEnUp);
   fChain->SetBranchAddress("e3_m_collinearmass_TauEnDown", &e3_m_collinearmass_TauEnDown, &b_e3_m_collinearmass_TauEnDown);
   fChain->SetBranchAddress("e3_m_collinearmass_TauEnUp", &e3_m_collinearmass_TauEnUp, &b_e3_m_collinearmass_TauEnUp);
   fChain->SetBranchAddress("e3_m_collinearmass_UnclusteredEnDown", &e3_m_collinearmass_UnclusteredEnDown, &b_e3_m_collinearmass_UnclusteredEnDown);
   fChain->SetBranchAddress("e3_m_collinearmass_UnclusteredEnUp", &e3_m_collinearmass_UnclusteredEnUp, &b_e3_m_collinearmass_UnclusteredEnUp);
   fChain->SetBranchAddress("e3_m_pt_tt", &e3_m_pt_tt, &b_e3_m_pt_tt);
   ...
   fChain->SetBranchAddress("m_e3_collinearmass", &m_e3_collinearmass, &b_m_e3_collinearmass);
   fChain->SetBranchAddress("m_e3_collinearmass_CheckUESDown", &m_e3_collinearmass_CheckUESDown, &b_m_e3_collinearmass_CheckUESDown);
   fChain->SetBranchAddress("m_e3_collinearmass_CheckUESUp", &m_e3_collinearmass_CheckUESUp, &b_m_e3_collinearmass_CheckUESUp);
   fChain->SetBranchAddress("m_e3_collinearmass_JetCheckTotalDown", &m_e3_collinearmass_JetCheckTotalDown, &b_m_e3_collinearmass_JetCheckTotalDown);
   fChain->SetBranchAddress("m_e3_collinearmass_JetCheckTotalUp", &m_e3_collinearmass_JetCheckTotalUp, &b_m_e3_collinearmass_JetCheckTotalUp);
   fChain->SetBranchAddress("m_e3_collinearmass_JetEnDown", &m_e3_collinearmass_JetEnDown, &b_m_e3_collinearmass_JetEnDown);
   fChain->SetBranchAddress("m_e3_collinearmass_JetEnUp", &m_e3_collinearmass_JetEnUp, &b_m_e3_collinearmass_JetEnUp);
   fChain->SetBranchAddress("m_e3_collinearmass_UnclusteredEnDown", &m_e3_collinearmass_UnclusteredEnDown, &b_m_e3_collinearmass_UnclusteredEnDown);
   fChain->SetBranchAddress("m_e3_collinearmass_UnclusteredEnUp", &m_e3_collinearmass_UnclusteredEnUp, &b_m_e3_collinearmass_UnclusteredEnUp);
...
void runchannelEEEM::Show(Long64_t entry)
{
...
Int_t runchannelEEEM::Cut(Long64_t entry)
{
...
#endif // #ifdef runchannelEEEM_cxx
