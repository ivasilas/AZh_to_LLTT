...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_e_t_collinearmass_CheckUESDown;   //!
   TBranch        *b_e_t_collinearmass_CheckUESUp;   //!
   TBranch        *b_e_t_collinearmass_EleEnDown;   //!
   TBranch        *b_e_t_collinearmass_EleEnUp;   //!
   TBranch        *b_e_t_collinearmass_JetCheckTotalDown;   //!
   TBranch        *b_e_t_collinearmass_JetCheckTotalUp;   //!
   TBranch        *b_e_t_collinearmass_JetEnDown;   //!
   TBranch        *b_e_t_collinearmass_JetEnUp;   //!
   TBranch        *b_e_t_collinearmass_MuEnDown;   //!
   TBranch        *b_e_t_collinearmass_MuEnUp;   //!
   ...
   TBranch        *b_t_e_collinearmass_CheckUESDown;   //!
   TBranch        *b_t_e_collinearmass_CheckUESUp;   //!
   TBranch        *b_t_e_collinearmass_JetCheckTotalDown;   //!
   TBranch        *b_t_e_collinearmass_JetCheckTotalUp;   //!
   ...
   runchannelMMET(const std::string SampleName,const int maxEvents, TTree *tree=0);
   virtual ~runchannelMMET();
   ...
   bool MMET_ZMMSelection(MMET_PartInfo aParticle);
 
};

#endif

#ifdef runchannelMMET_cxx
runchannelMMET::runchannelMMET(const std::string SampleName, const int maxEvents, TTree *tree) //: fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TChain *mychain = new TChain("emmt/final/Ntuple");
//"Ntuple/tree");
...
runchannelMMET::~runchannelMMET()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t runchannelMMET::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t runchannelMMET::LoadTree(Long64_t entry)
{
...
void runchannelMMET::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("e_t_CosThetaStar", &e_t_CosThetaStar, &b_e_t_CosThetaStar);
   fChain->SetBranchAddress("e_t_DPhi", &e_t_DPhi, &b_e_t_DPhi);
   fChain->SetBranchAddress("e_t_DR", &e_t_DR, &b_e_t_DR);
   fChain->SetBranchAddress("e_t_Eta", &e_t_Eta, &b_e_t_Eta);
   fChain->SetBranchAddress("e_t_Mass", &e_t_Mass, &b_e_t_Mass);
   fChain->SetBranchAddress("e_t_Mass_TauEnDown", &e_t_Mass_TauEnDown, &b_e_t_Mass_TauEnDown);
   fChain->SetBranchAddress("e_t_Mass_TauEnUp", &e_t_Mass_TauEnUp, &b_e_t_Mass_TauEnUp);
   fChain->SetBranchAddress("e_t_Mt", &e_t_Mt, &b_e_t_Mt);
   fChain->SetBranchAddress("e_t_MtTotal", &e_t_MtTotal, &b_e_t_MtTotal);
   fChain->SetBranchAddress("e_t_Mt_TauEnDown", &e_t_Mt_TauEnDown, &b_e_t_Mt_TauEnDown);
   fChain->SetBranchAddress("e_t_Mt_TauEnUp", &e_t_Mt_TauEnUp, &b_e_t_Mt_TauEnUp);
   fChain->SetBranchAddress("e_t_MvaMet", &e_t_MvaMet, &b_e_t_MvaMet);
   fChain->SetBranchAddress("e_t_MvaMetCovMatrix00", &e_t_MvaMetCovMatrix00, &b_e_t_MvaMetCovMatrix00);
   fChain->SetBranchAddress("e_t_MvaMetCovMatrix01", &e_t_MvaMetCovMatrix01, &b_e_t_MvaMetCovMatrix01);
   fChain->SetBranchAddress("e_t_MvaMetCovMatrix10", &e_t_MvaMetCovMatrix10, &b_e_t_MvaMetCovMatrix10);
   fChain->SetBranchAddress("e_t_MvaMetCovMatrix11", &e_t_MvaMetCovMatrix11, &b_e_t_MvaMetCovMatrix11);
   fChain->SetBranchAddress("e_t_MvaMetPhi", &e_t_MvaMetPhi, &b_e_t_MvaMetPhi);
   fChain->SetBranchAddress("e_t_PZeta", &e_t_PZeta, &b_e_t_PZeta);
   fChain->SetBranchAddress("e_t_PZetaLess0p85PZetaVis", &e_t_PZetaLess0p85PZetaVis, &b_e_t_PZetaLess0p85PZetaVis);
   fChain->SetBranchAddress("e_t_PZetaVis", &e_t_PZetaVis, &b_e_t_PZetaVis);
   fChain->SetBranchAddress("e_t_Phi", &e_t_Phi, &b_e_t_Phi);
   fChain->SetBranchAddress("e_t_Pt", &e_t_Pt, &b_e_t_Pt);
   fChain->SetBranchAddress("e_t_SS", &e_t_SS, &b_e_t_SS);
   fChain->SetBranchAddress("e_t_ToMETDPhi_Ty1", &e_t_ToMETDPhi_Ty1, &b_e_t_ToMETDPhi_Ty1);
   fChain->SetBranchAddress("e_t_collinearmass", &e_t_collinearmass, &b_e_t_collinearmass);
   fChain->SetBranchAddress("e_t_collinearmass_CheckUESDown", &e_t_collinearmass_CheckUESDown, &b_e_t_collinearmass_CheckUESDown);
   fChain->SetBranchAddress("e_t_collinearmass_CheckUESUp", &e_t_collinearmass_CheckUESUp, &b_e_t_collinearmass_CheckUESUp);
   fChain->SetBranchAddress("e_t_collinearmass_EleEnDown", &e_t_collinearmass_EleEnDown, &b_e_t_collinearmass_EleEnDown);
   fChain->SetBranchAddress("e_t_collinearmass_EleEnUp", &e_t_collinearmass_EleEnUp, &b_e_t_collinearmass_EleEnUp);
   fChain->SetBranchAddress("e_t_collinearmass_JetCheckTotalDown", &e_t_collinearmass_JetCheckTotalDown, &b_e_t_collinearmass_JetCheckTotalDown);
   fChain->SetBranchAddress("e_t_collinearmass_JetCheckTotalUp", &e_t_collinearmass_JetCheckTotalUp, &b_e_t_collinearmass_JetCheckTotalUp);
   fChain->SetBranchAddress("e_t_collinearmass_JetEnDown", &e_t_collinearmass_JetEnDown, &b_e_t_collinearmass_JetEnDown);
   fChain->SetBranchAddress("e_t_collinearmass_JetEnUp", &e_t_collinearmass_JetEnUp, &b_e_t_collinearmass_JetEnUp);
   fChain->SetBranchAddress("e_t_collinearmass_MuEnDown", &e_t_collinearmass_MuEnDown, &b_e_t_collinearmass_MuEnDown);
   fChain->SetBranchAddress("e_t_collinearmass_MuEnUp", &e_t_collinearmass_MuEnUp, &b_e_t_collinearmass_MuEnUp);
   fChain->SetBranchAddress("e_t_collinearmass_TauEnDown", &e_t_collinearmass_TauEnDown, &b_e_t_collinearmass_TauEnDown);
   fChain->SetBranchAddress("e_t_collinearmass_TauEnUp", &e_t_collinearmass_TauEnUp, &b_e_t_collinearmass_TauEnUp);
   fChain->SetBranchAddress("e_t_collinearmass_UnclusteredEnDown", &e_t_collinearmass_UnclusteredEnDown, &b_e_t_collinearmass_UnclusteredEnDown);
   fChain->SetBranchAddress("e_t_collinearmass_UnclusteredEnUp", &e_t_collinearmass_UnclusteredEnUp, &b_e_t_collinearmass_UnclusteredEnUp);
   fChain->SetBranchAddress("e_t_pt_tt", &e_t_pt_tt, &b_e_t_pt_tt);
   ...
   fChain->SetBranchAddress("t_e_collinearmass", &t_e_collinearmass, &b_t_e_collinearmass);
   fChain->SetBranchAddress("t_e_collinearmass_CheckUESDown", &t_e_collinearmass_CheckUESDown, &b_t_e_collinearmass_CheckUESDown);
   fChain->SetBranchAddress("t_e_collinearmass_CheckUESUp", &t_e_collinearmass_CheckUESUp, &b_t_e_collinearmass_CheckUESUp);
   fChain->SetBranchAddress("t_e_collinearmass_JetCheckTotalDown", &t_e_collinearmass_JetCheckTotalDown, &b_t_e_collinearmass_JetCheckTotalDown);
   fChain->SetBranchAddress("t_e_collinearmass_JetCheckTotalUp", &t_e_collinearmass_JetCheckTotalUp, &b_t_e_collinearmass_JetCheckTotalUp);
   fChain->SetBranchAddress("t_e_collinearmass_JetEnDown", &t_e_collinearmass_JetEnDown, &b_t_e_collinearmass_JetEnDown);
   fChain->SetBranchAddress("t_e_collinearmass_JetEnUp", &t_e_collinearmass_JetEnUp, &b_t_e_collinearmass_JetEnUp);
   fChain->SetBranchAddress("t_e_collinearmass_UnclusteredEnDown", &t_e_collinearmass_UnclusteredEnDown, &b_t_e_collinearmass_UnclusteredEnDown);
   fChain->SetBranchAddress("t_e_collinearmass_UnclusteredEnUp", &t_e_collinearmass_UnclusteredEnUp, &b_t_e_collinearmass_UnclusteredEnUp);
...
void runchannelMMET::Show(Long64_t entry)
{
...
Int_t runchannelMMET::Cut(Long64_t entry)
{
...
#endif // #ifdef runchannelMMET_cxx
