#define runchannelEEMT_cxx
#include "runchannelEEMT.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <cmath>
void runchannelEEMT::Loop(const std::string SampleName,const int maxEvents)
{
//   In a ROOT session, you can do:
//      Root > .L runchannelEEMT.C
//      Root > runchannelEEMT t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   runchannelEEMT::EEMT_PartInfo aParticle;
   ...
   cout<<"RUNNING SAMPLE "<<SampleName<<" runchannel CHANNEL EEMT"<<endl;
   TString fullName = SampleName+"EEMT.root";
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if (eVetoAZHdR0>2 || muVetoAZHdR0>1) continue;
      ...
      if(abs(mEta) >= 2.4 || mPt <= 10 || abs(mPVDXY)>=0.045 || abs(mPVDZ) >= 0.2 || m_t_DR <= 0.5 ) continue; 
      ...
      if (!(EEMT_ZEESelection(aParticle))) continue;
  ...
  // leptons var
     ...
     RelIsoDB_3=mRelPFIsoDBDefaultR04;
     RelIsoDB_4=-9999.0;
     // Event ID Var
     run_1=run; 
     lumi_1= lumi; 	 
     ...
     MvaMetCovMatrix00_1_3= e1_m_MvaMetCovMatrix00;
     MvaMetCovMatrix01_1_3= e1_m_MvaMetCovMatrix01;
     MvaMetCovMatrix10_1_3= e1_m_MvaMetCovMatrix10;
     MvaMetCovMatrix11_1_3= e1_m_MvaMetCovMatrix11;
     ...
     MvaMetCovMatrix00_2_3= e2_m_MvaMetCovMatrix00;
     MvaMetCovMatrix01_2_3= e2_m_MvaMetCovMatrix01;
     MvaMetCovMatrix10_2_3= e2_m_MvaMetCovMatrix10;
     MvaMetCovMatrix11_2_3= e2_m_MvaMetCovMatrix11;
     ...
     MvaMetCovMatrix00_3_4= m_t_MvaMetCovMatrix00;
     MvaMetCovMatrix01_3_4= m_t_MvaMetCovMatrix01;
     MvaMetCovMatrix10_3_4= m_t_MvaMetCovMatrix10;
     MvaMetCovMatrix11_3_4= m_t_MvaMetCovMatrix11;
     ...
     PFChargedIso_3 = mPFChargedIso;
     PFNeutralIso_3 = mPFNeutralIso;
     PFPUChargedIso_3 = mPFPUChargedIso;
     PFPhotonIso_3 = mPFPhotonIso;
     ...
     isTracker_1 = 1;
     isTracker_2 = 1;
     isTracker_3 = mIsTracker;
     isTracker_4 = 1;
     
     isGlobal_1 = 1;
     isGlobal_2 = 1;
     isGlobal_3 = mIsGlobal;
     isGlobal_4 = 1;
     ...
     ZTTGenMatching_3=mZTTGenMatching;
     ...
     JetEtaEtaMoment_3=mJetEtaEtaMoment;
     JetEtaPhiMoment_3=mJetEtaPhiMoment;
     JetPhiPhiMoment_3=mJetPhiPhiMoment;
...
bool runchannelEEMT::EEMT_ZEESelection(EEMT_PartInfo aParticle)
{
